...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    // It will store students infomation (id(integer), first name, last name, gender, course name, age(integer), address)
    func storeStuInfo (student_id: Int, first_name: String, last_name: String, gender: String, course_study: String, age: Int, address: String){
        ...
        // It will retrieves the entity "Student"
        let entity = NSEntityDescription.entity(forEntityName: "Student", in: context)
        let transc = NSManagedObject(entity: entity!, insertInto: context)
        
        // Entity "Student" value
    ...
    // It will delete student information
    ...
    // It will get student ID in array form
    ...
    // It will remove all student infomation
    func removeRecords () {
        let context = getContext()
    ...
    // It will store Exam information
